WITH input_data AS (
    ...
    SELECT
        ...
        (item_data->>'feedback_form_email_sent')::BOOLEAN AS feedback_form_email_sent,
...
INSERT INTO calendly_meetings (
    ...
    interview_date,
    editor_link,
    feedback_form_email_sent,
    feedback_form_email_timestamp
)
SELECT
    id.event_id,
    id.created_at,
    ...
    id.interview_date,
    id.editor_link,
    id.feedback_form_email_sent,
    id.feedback_form_email_timestamp
FROM input_data id
ON CONFLICT (event_id) DO UPDATE SET
    ...
    feedback_form_email_sent = EXCLUDED.feedback_form_email_sent,
    feedback_form_email_timestamp = EXCLUDED.feedback_form_email_timestamp;